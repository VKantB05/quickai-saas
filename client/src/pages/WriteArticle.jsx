...
const WriteArticle = () => {
  ...
  {/* Prevent Webpage form reloading while we submit the form*/ }
  const onSubmitHandler = async (e) => {
    e.preventDefault();
    try {
      setLoading(true);
     const prompt = `Write a detailed article of at least ${selectedLength.length} words on "${input}". Do not summarize. Write in paragraphs.`;
